...
INSERT INTO `adherent` (`email`, `username`, `password`, `role`) VALUES
	('admin@seed.com', 'admin', 'f4f263e439cf40925e6a412387a9472a6773c2580212a4fb50d224d3a817de17', 'admin'),
...
INSERT INTO `jeux` (`id`, `nom`, `prix`, `studio`, `annee`, `type`, `resume`, `img_url`) VALUES
	...
	(11, 'Outer wilds', '80.5', 'mobius digital', '2019-05-13', 'Simulation spacial', 'Outer Wilds est jeu dans lequel vous êtes le nouveau venu dans un programme spatial d\'Outer Wilds Ventures. ', 'https://image.api.playstation.com/vulcan/ap/rnd/202208/1623/Zofebh60Ue7Zt5sC10UAtU3D.png');
...
INSERT INTO `livre` (`id`, `nom`, `prix`, `auteur`, `studio`, `type`, `resume`, `img_url`, `annee`) VALUES
	...
	(14, 'Le Seigneur des Anneaux', '20', 'J.R.R. Tolkien', '1954-07-29', 'Roman de fantasy', 'Le Seigneur des Anneaux raconte l\'histoire d\'un hobbit nommé Frodon qui part en quête pour détruire un anneau magique.', 'https://m.media-amazon.com/images/I/514+aP+SZ+L._SX349_BO1,204,203,200_.jpg', 1823),
	(15, 'Orgueil et Préjugés', '8', 'Jane Austen', '1813-01-28', 'Roman romantique', 'Orgueil et Préjugés raconte l\'histoire d\'une famille anglaise bourgeoise dans les années 1800.', 'https://m.media-amazon.com/images/I/81nKAJtQ+uL.jpg', 1970),
	(16, 'Les Misérables', '15', 'Victor Hugo', '1862-04-05', 'Roman historique', 'Les Misérables raconte l\'histoire d\'un homme appelé Jean Valjean qui doit faire face aux défis de la société française du XIXe siècle.', 'https://m.media-amazon.com/images/I/71lxLN4vorL.jpg', 1940),
	(17, 'Le Crime de l\'Orient-Express', '10', 'Agatha Christie', '1934-01-01', 'Roman policier', 'Le Crime de l\'Orient-Express raconte l\'histoire d\'un meurtre qui se produit à bord de l\'Orient-Express.', 'https://m.media-amazon.com/images/I/71DYNs3ybnL.jpg', 1960),
